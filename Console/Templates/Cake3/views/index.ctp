...
<div class="<?php echo $pluralVar; ?> index large-9 medium-8 columns content">
	...
	<?php foreach ($fields as $field): ?>
		<th scope="col"><?php echo "<?php echo \$this->Paginator->sort('{$field}'); ?>"; ?></th>
	<?php endforeach; ?>
		<th scope="col" class="actions"><?php echo "<?php echo __('Actions'); ?>"; ?></th>
	</tr>
	</thead>
	<tbody>
	<?php
	...
	<div class="paginator">
		...
		<?php
			...
			echo "\t\techo \$this->Paginator->next(__('next') . ' >', array('tag' => 'li'), null, array('class' => 'next disabled', 'disabledTag' => 'a'));\n";
			echo "\t?>\n";
		?>
		</ul>
		<p><?php echo "<?php echo \$this->Paginator->counter(array('format' => __('{:page} of {:pages}'))); ?>"; ?></p>
	</div>
</div>
